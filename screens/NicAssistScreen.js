...
useEffect(() => {
  if (
    ...
    const coords = [
      { latitude: userALocation.latitude, longitude: userALocation.longitude },
      { latitude: userBLocation.latitude, longitude: userBLocation.longitude },
    ];
    ...
    didFitMap.current = true; // ✅ only run once
  }
